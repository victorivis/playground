...
Superficie::Superficie(const char p_filePath[]){
    superficie_imagem = IMG_Load(p_filePath);
}

Superficie::~Superficie(){
    SDL_FreeSurface(superficie_imagem);
    std::cout << "Superficie liberada com sucesso.\n";
}
